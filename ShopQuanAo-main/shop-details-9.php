                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-11.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-11.jpg"></div>

                            <h4>White Utility Backpack</h4>

                            <h3>$60.9 <span>100.00</span></h3>
                            <p>
                                The "white utility backpack" is a sleek, functional accessory
                                designed for those who value both style and practicality. Made
                                from durable materials, this backpack features a clean white
                                color that offers a modern, minimalist look. It includes
                                multiple zippered compartments—typically a large main section
                                for essentials, along with smaller front and side pockets for
                                organizing smaller items like keys, a phone, or accessories.
                                The adjustable shoulder straps and padded back provide comfort
                                for extended wear, while the sturdy top handle offers an
                                alternative carrying option. This versatile backpack is ideal
                                for urban commuting, school, or light travel, combining
                                utility with a fresh, contemporary aesthetic.
                            </p>
                        </div>
                        <div class="khung">
