                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-2.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-2.jpg"></div>
                            <h4>Piqué Biker Jacket</h4>

                            <h3>$67.24 <span>100.00</span></h3>
                            <p>
                                Piqué Biker Jacket – This jacket combines a rugged biker style
                                with a refined piqué fabric that offers both warmth and
                                breathability. The tailored fit, accented with metallic
                                details and standout zippers, creates a bold and stylish look.
                                Featuring a classic biker collar and long sleeves, this jacket
                                pairs easily with various outfits, adding a youthful and edgy
                                touch to any ensemble. Perfect for different occasions, from
                                casual outings to meetups with friends.
                            </p>
