                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-8.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-8.jpg"></div>

                            <h4>Navy Henley T-shirt</h4>

                            <h3>$26.28 <span>100.00</span></h3>
                            <p>
                                The "navy Henley T-shirt" is a casual yet refined wardrobe
                                staple, featuring a deep navy color that adds a subtle
                                sophistication. This T-shirt is designed with the classic
                                Henley collar, which includes a short button placket for
                                adjustable comfort and a distinctive look. Short sleeves and a
                                soft, breathable fabric make it ideal for warm weather or
                                layering under jackets in cooler seasons. The navy color pairs
                                easily with jeans, chinos, or shorts, making it a versatile
                                choice for everyday wear. Its simple yet stylish design suits
                                both relaxed and slightly dressier casual settings.
                            </p>
                        </div>
                        <div class="khung">
