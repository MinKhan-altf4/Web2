                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-14.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-14.jpg"></div>

                            <h4>Gold Rectangular Cufflinks</h4>

                            <h3>$26.28 <span>100.00</span></h3>
                            <p>
                                The "gold rectangular cufflinks" are elegant, minimalist
                                accessories crafted in a sleek rectangular shape with a
                                polished gold finish. Designed to add a touch of
                                sophistication to formal attire, these cufflinks are perfect
                                for securing the cuffs of a dress shirt in a refined,
                                understated manner. The simple rectangular shape complements
                                various styles, from business suits to evening wear, adding a
                                subtle yet luxurious accent. These cufflinks are ideal for
                                those who appreciate classic design with a modern edge, making
                                them a timeless addition to any wardrobe for special occasions
                        ...
                        <div class="khung">
                            <a href="#" class="buttonn" data-price="26.28">Add To Cart</a>
                        </div>
                        <br>
                            ...
                            <div class="tab-pane active" id="tabs-5" role="tabpanel">
                                <div class="product__details__tab__content">
                                    ...
                                    <div class="product__details__tab__content__item">
                                        ...
                                        <p>
                                            The "gold rectangular cufflinks" are elegant,
                                            minimalist accessories crafted in a sleek rectangular
                                            shape with a polished gold finish. Designed to add a
                                            touch of sophistication to formal attire, these
                                            cufflinks are perfect for securing the cuffs of a
                                            dress shirt in a refined, understated manner. The
                                            simple rectangular shape complements various styles,
                                            from business suits to evening wear, adding a subtle
                                            yet luxurious accent. These cufflinks are ideal for
                                            those who appreciate classic design with a modern
                                            edge, making them a timeless addition to any wardrobe
                                            for special occasions or professional settings.
                                        </p>
                                        <p>
