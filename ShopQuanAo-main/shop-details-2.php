                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-3.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-3.jpg"></div>
                            <h4>Black Sneaker</h4>

                            <h3>$43.48 <span>70.00</span></h3>
                            <p>
                                A "black sneaker" typically refers to a versatile, casual shoe
                                with a sleek black design. It may feature a low or mid-top
                                style with a lace-up front for a secure fit. The all-black
                                color offers a minimalist look that pairs well with a variety
                                of outfits, from casual jeans to athleisure wear. Depending on
                                the style, it might include features like a cushioned insole,
                                rubber sole for traction, and subtle branding or detailing.
                                This type of sneaker is suitable for both everyday wear and
                                light physical activities, combining comfort with modern
                                style.
                            </p>
