                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-12.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-12.jpg"></div>

                            <h4>Camouflage Hooded Jacket</h4>

                            <h3>$98.49 <span>100.00</span></h3>
                            <p>
                                The "camouflage hooded jacket" is a rugged, stylish outerwear
                                piece designed for both functionality and fashion. It features
                                a classic camouflage print in shades of green, brown, and
                                beige, lending it an outdoorsy, military-inspired aesthetic.
                                This jacket usually includes a hood with drawstrings, a zip or
                                button front closure, and multiple pockets for practical
                                storage. The relaxed fit and durable material make it suitable
                                for various weather conditions and activities, from casual
                                outings to outdoor adventures. This versatile jacket is ideal
                                for those seeking a blend of comfort, style, and utility,
                                adding a bold, edgy look to any outfit.
                            </p>
                        </div>
                        <div class="khung">
                            ...
                            <div class="tab-pane active" id="tabs-5" role="tabpanel">
                                <div class="product__details__tab__content">
                                    ...
                                    <div class="product__details__tab__content__item">
                                        ...
                                        <p>
                                            The "camouflage hooded jacket" is a rugged, stylish
                                            outerwear piece designed for both functionality and
                                            fashion. It features a classic camouflage print in
                                            shades of green, brown, and beige, lending it an
                                            outdoorsy, military-inspired aesthetic. This jacket
                                            usually includes a hood with drawstrings, a zip or
                                            button front closure, and multiple pockets for
                                            practical storage. The relaxed fit and durable
                                            material make it suitable for various weather
                                            conditions and activities, from casual outings to
                                            outdoor adventures. This versatile jacket is ideal for
                                            those seeking a blend of comfort, style, and utility,
                                            adding a bold, edgy look to any outfit.
                                        </p>
                                        <p>
