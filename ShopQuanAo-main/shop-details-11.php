                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-13.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-13.jpg"></div>

                            <h4>Brown Leather Briefcase</h4>

                            <h3>$49.66 <span>100.00</span></h3>
                            <p>
                                The "brown leather briefcase" is a sophisticated, professional
                                accessory, crafted from high-quality leather in a rich brown
                                tone that exudes timeless elegance. This briefcase is designed
                                with a structured, rectangular silhouette, featuring sturdy
                                handles and often a detachable shoulder strap for versatile
                                carrying options. It includes a main compartment spacious
                                enough for documents, a laptop, and other essentials, along
                                with additional pockets or compartments for organizing smaller
                                items like pens, a phone, or business cards. The leather
                                finish adds durability and a polished look, making this
                                briefcase ideal for business professionals seeking a blend of
                        ...
                        <div class="khung">
                            <a href="#" class="buttonn" data-price="49.66">Add To Cart</a>
                        </div>
                        <br>
                            ...
                            <div class="tab-pane active" id="tabs-5" role="tabpanel">
                                <div class="product__details__tab__content">
                                    ...
                                    <div class="product__details__tab__content__item">
                                        ...
                                        <p>
                                            The "brown leather briefcase" is a sophisticated,
                                            professional accessory, crafted from high-quality
                                            leather in a rich brown tone that exudes timeless
                                            elegance. This briefcase is designed with a
                                            structured, rectangular silhouette, featuring sturdy
                                            handles and often a detachable shoulder strap for
                                            versatile carrying options. It includes a main
                                            compartment spacious enough for documents, a laptop,
                                            and other essentials, along with additional pockets or
                                            compartments for organizing smaller items like pens, a
                                            phone, or business cards. The leather finish adds
                                            durability and a polished look, making this briefcase
                                            ideal for business professionals seeking a blend of
                                            functionality and classic style.
                                        </p>
                                        <p>
