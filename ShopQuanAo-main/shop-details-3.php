                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-4.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-4.jpg"></div>

                            <h4>Brown Hooded Shirt Jacket</h4>

                            <h3>$60.9 <span>70.00</span></h3>
                            <p>
                                The "brown hooded shirt jacket" is a stylish and versatile
                                outerwear piece that combines elements of a hoodie and a
                                shirt. It is crafted in a warm, earthy brown tone that adds a
                                rustic yet modern touch to casual outfits. This jacket
                                typically features a button-down front, similar to a classic
                                shirt, along with a hood and drawstrings for added warmth and
                                a relaxed look. With a single chest pocket, it provides
                                functional storage while maintaining a clean, minimalist
                                design. The shirt jacket is ideal for layering in cooler
                                weather, offering comfort and style that complements both
                                urban and outdoor settings.
                            </p>
                        </div>
                        <div class="khung">
                            <a href="#" class="buttonn" data-price="60.9">Add To Cart</a>
                        </div>
                        <br>
                            ...
                            <div class="tab-pane active" id="tabs-5" role="tabpanel">
                                <div class="product__details__tab__content">
                                    ...
                                    <div class="product__details__tab__content__item">
                                        ...
                                        <p>
                                            A "black sneaker" typically refers to a versatile,
                                            casual shoe with a sleek black design. It may feature
                                            a low or mid-top style with a lace-up front for a
                                            secure fit. The all-black color offers a minimalist
                                            look that pairs well with a variety of outfits, from
                                            casual jeans to athleisure wear. Depending on the
                                            style, it might include features like a cushioned
                                            insole, rubber sole for traction, and subtle branding
                                            or detailing. This type of sneaker is suitable for
                                            both everyday wear and light physical activities,
                                            combining comfort with modern style.
                                        </p>
                                        <p>
