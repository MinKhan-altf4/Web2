                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-9.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-9.jpg"></div>

                            <h4>Black Floral Graphic T-shirt</h4>

                            <h3>$67.24 <span>100.00</span></h3>
                            <p>
                                The "black floral graphic T-shirt" is a trendy and
                                eye-catching piece that combines casual comfort with a bold
                                design. Set against a solid black background, this T-shirt
                                features a vibrant floral graphic, usually positioned on one
                                side or across the chest, adding a splash of color and a touch
                                of nature-inspired style. The floral print brings a unique
                                contrast, enhancing the overall aesthetic and giving the shirt
                                a fresh, modern appeal. Made from soft, breathable fabric,
                                it’s ideal for casual outings and pairs well with jeans or
                                shorts. This T-shirt is perfect for those looking to add a bit
                                of artistic flair to their everyday wardrobe.
                            </p>
                        </div>
                        <div class="khung">
                            <a href="#" class="buttonn" data-price="67.24">Add To Cart</a>
                        </div>
                        <br>
                            ...
                            <div class="tab-pane active" id="tabs-5" role="tabpanel">
                                <div class="product__details__tab__content">
                                    ...
                                    <div class="product__details__tab__content__item">
                                        ...
                                        <p>
                                            The "black floral graphic T-shirt" is a trendy and
                                            eye-catching piece that combines casual comfort with a
                                            bold design. Set against a solid black background,
                                            this T-shirt features a vibrant floral graphic,
                                            usually positioned on one side or across the chest,
                                            adding a splash of color and a touch of
                                            nature-inspired style. The floral print brings a
                                            unique contrast, enhancing the overall aesthetic and
                                            giving the shirt a fresh, modern appeal. Made from
                                            soft, breathable fabric, it’s ideal for casual outings
                                            and pairs well with jeans or shorts. This T-shirt is
                                            perfect for those looking to add a bit of artistic
                                            flair to their everyday wardrobe.
                                        </p>
                                        <p>
