                        ...
                        <div class="tab-content" style="height: 100%">
                            <div class="tab-pane active" id="tabs-1" role="tabpanel" style="height: 100%">
                                <div class="product__details__pic__item" style="height: 100%; align-items: center">
                                    <img src="img/product/product-7.jpg" alt="" style="height: 100%; width: 50%" />
                                </div>
                            </div>
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            <div class="set-bg" data-setbg="img/product/product-7.jpg"></div>

                            <h4>Brown Leather Backpack</h4>

                            <h3>$49.66 <span>100.00</span></h3>
                            <p>
                                The "brown leather backpack" is a sophisticated and functional
                                accessory, ideal for both everyday use and travel. Crafted
                                from durable, high-quality leather, it features a rich brown
                                tone that gives it a classic, timeless appeal. The backpack
                                typically includes a main compartment spacious enough to hold
                                essentials like books, a laptop, or personal items, along with
                                a front zippered pocket for easy access to smaller belongings.
                                The adjustable shoulder straps provide comfort, while the
                                minimalist design and leather material add a touch of
                                elegance. This backpack is perfect for those who seek both
                                style and practicality in their accessories.
                            </p>
                        </div>
                        <div class="khung">
